...
define void @test_bindings() {
  ...
  ; CHECK: [[BUF0:%[0-9]*]] = call %dx.types.Handle @dx.op.createHandle(i32 218, %dx.types.ResBind { i32 5, i32 5, i32 3, i8 1 }, i32 4, i1 false)
  ...
  ; CHECK: [[BUF1:%[0-9]*]] = call %dx.types.Handle @dx.op.createHandle(i32 218, %dx.types.ResBind { i32 7, i32 7, i32 2, i8 1 }, i32 6, i1 false)
  ...
  ; CHECK: [[BUF2:%[0-9]*]] = call %dx.types.Handle @dx.op.createHandle(i32 218, %dx.types.ResBind { i32 7, i32 30, i32 2, i8 0 }, i32 8, i1 false)
  ...
  ; CHECK: [[BUF3:%[0-9]*]] = call %dx.types.Handle @dx.op.createHandle(i32 218, %dx.types.ResBind { i32 2, i32 2, i32 4, i8 0 }, i32 10, i1 true)
  ...
  ; CHECK: [[BUF4:%[0-9]*]] = call %dx.types.Handle @dx.op.createHandle(i32 218, %dx.types.ResBind { i32 8, i32 8, i32 1, i8 0 }, i32 12, i1 false)
